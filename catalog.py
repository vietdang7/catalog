...
def editCategory(category_id):
    ...
    if editedCategory.user_id != login_session['user_id']:
        return "<script>function myFunction()\
                ...
                this category. Please create your own category\
        ...
        return "<script>function myFunction()\
                {alert('You are not authorized\
                 to delete this category. Please\
                  create your own category in \
                  order to delete it.');}</script>\
                  <body onload='myFunction()''>"
    if request.method == 'POST':
...
def newItem():
    ...
    if request.method == 'POST':
        newItem = CatalogItem(name=request.form['name'],
                              ...
                              category_id=request.form['radio'],
                              user_id=login_session['user_id'])
        session.add(newItem)
        session.commit()
        # Send message to user in main.html
...
def editItem(item_id):
    ...
    if editedItem.user_id != login_session['user_id']:
        return "<script>function myFunction()\
               ...
               edit this item. Please create your \
               own item in order to edit it.');}\
...
def deleteItem(item_id):
    ...
    if deletedItem.user_id != login_session['user_id']:
        return "<script>function myFunction()\
                {alert('You are not authorized\
                 to edit this item. Please create\
                  your own item in order to edit \
                  it.');}</script><body onload='myFunction()''>"
    if request.method == 'POST':
